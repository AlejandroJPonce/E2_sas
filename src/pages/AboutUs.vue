...
const items = [
  {
    id: 1,
    title: "Transparencia y sinceridad",
    icon: zoomIcon,
  },
  {
    id: 2,
...
<template>
  ...
  >
    ...
    <div class="w-full text-justify lg:text-center">
      <span class="text-white lg:text-3xl font-light"
        >Estructuraciones y Estrategias S.A.S., E2, Es una empresa que busca
        satisfacer de manera integral las necesidades visibles del mercado en
        materia de necesidades de las entidades públicas y privadas. Conformada
        por un equipo interdisciplinario, ofrece una amplia asesoría y
        acompañamiento en la estructuración de proyectos públicos y privados,
        desde tres áreas fundamentales: Técnico, jurídico y Financiero. Con la
        intención de representar, guiar y gestionar cada proceso de nuestros
        clientes, desde un enfoque estratégico e innovador en el que se
        satisfagan sus necesidades y expectativas.
      </span>
    </div>

    <div
      class="absolute w-full h-[90px] lg:h-[140px] bottom-0 bg-[#e5e5e5] z-10"
    >
      <div class="relative">
        <div
  ...
  <section
    class="relative flex flex-col gap-3 lg:gap-10 items-start justify-center w-full h-[650p] md:h-[calc(60vh) lg:h-[calc(60vh)] bg-[#e5e5e5] pt-5 pb-20 px-15 lg:pb-0 lg:py-15 lg:px-20"
  >
    <div>
      <span class="text-gray-600 text-2xl lg:text-6xl font-bold"
        >Nuestra Misión</span
      >
    </div>
    <div class="lg:w-[90%] text-justify lg:text-left">
      <span class="text-gray-600 text-1xl lg:text-4xl font-light"
        >Brindar soluciones integrales a entidades públicas y privadas mediante
        asesoría y acompañamiento técnico, jurídico y financiero, garantizando
        la estructuración eficiente de proyectos con un enfoque estratégico,
        innovador y orientado a satisfacer las necesidades y expectativas de
        nuestros clientes.
      </span>
    </div>
  </section>
  ...
  >
    <div class="relative flex items-center justify-center lg:w-[50%]">
      <iframe
        class="rounded-2xl w-80 h-55 sm:w-145 sm:h-105"
    ...
    <div class="lg:w-[50%] flex flex-col gap-5">
      ...
      <div class="lg:w-[90%] text-justify lg:text-left">
        <span class="text-gray-600 text-1xl lg:text-4xl font-light"
          >Ser reconocidos a nivel nacional como una empresa líder en soluciones
          integrales para empresas y proyectos, destacándonos por nuestra
          innovación, eficiencia, responsabilidad y capacidad de generar
          relaciones duraderas basadas en la confianza y la excelencia en el
          servicio.
        </span>
      </div>
    </div>
  ...
  <HeroWhiteSection bg-color="#e5e5e5">
    <div
      class="flex flex-col items-center justify-center lg:justify-start w-full gap-10 lg:p-5 lg:pt-30 lg:gap-15"
    >
      <span
      ...
      <div
        class="lg:h-[60%] gap-4 lg:gap-20 flex lg:flex-row flex-wrap lg:flex-nowrap items-center justify-center"
      >
        <div
          v-for="info in items"
