...
<template>
  <nav
    :class="[
      'sticky top-0 left-0 transition-all duration-300 z-11 mx-h-[88px] w-full after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 border-0',
      isScrolled
      ...
      <div class="relative flex h-22 items-center justify-between">
        ...
        >
          ...
          <div @click="goHome" class="flex shrink-0 items-center">
            <img
              v-if="isScrolled"
              src="../assets/E2_icon.png"
              alt="Your Company"
              :class="[isScrolled ? 'ml-0' : 'ml-12', 'h-10 w-auto']"
            />
            <img
              v-else
              src="../assets/E2_icon.png"
          ...
          <div class="hidden sm:ml-6 sm:block">
            ...
            >
              ...
              <a
                href="/"
                aria-current="page"
                class="rounded-md px-3 py-2 text-sm sm:text-xl lg:text-md font-bold"
                data-link="home"
                >Inicio</a
              >
              <a
    ...
    <div id="mobile-menu" :class="{ hidden: !toggle_menu }">
      ...
      >
        <a
          href="/"
          aria-current="page"
          class="rounded-md px-3 py-2 text-sm sm:text-xl font-bold"
          >Inicio</a
        >
        <a href="/conocenos" class="rounded-md px-3 py-2 text-sm sm:text-xl font-bold"
          >¿Quienes somos?</a
        >
        <a href="/servicios" class="rounded-md px-3 py-2 text-sm sm:text-xl font-bold">Servicios</a>
        <a href="/galeria" class="rounded-md px-3 py-2 text-sm sm:text-xl font-bold">Galería</a>
      </div>
    </div>
  </nav>
</template>
